    ...
    const payConfig = {
        ...
        data: {
            payment_id: "txreq_HeqMWnpWVvzdpMXiB4I123456",
             // The `id` property returned from the Initiate Payments API response object.
            amount: 1000,
            type: "onetime-debit",
                ...
                >
                    ...
                    <View style={[styles.trendingDestinations1, styles.mt30]}>
                        ...
                        >
                            ...
                            <Button mode="contained" style={styles.TabButton} labelStyle={{ color: "white", fontSize: 14 }} onPress={()=>init()}>
                                Submit
                            </Button>
                        </ScrollView>
                    </View>
