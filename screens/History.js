    ...
    <View style={styles.explore}>
      ...
      >
        ...
        <View style={[styles.trendingDestinations1, styles.mt30, styles.FLEX]}>
          <TouchableOpacity style={styles.TabButton} onPress={() => console.log('Pressed')}>
            <Text style={{ color: "white", lineHeight: 12, fontSize: 12, paddingHorizontal: 1 }}>ALL</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.TabButton} onPress={() => console.log('Pressed')}>
            <Text style={{ color: "white", lineHeight: 12, fontSize: 12, paddingHorizontal: 1 }}>SWAP</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.TabButton} onPress={() => console.log('Pressed')}>
            <Text style={{ color: "white", lineHeight: 12, fontSize: 12, paddingHorizontal: 1 }}>DEPOSIT</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.TabButton} onPress={() => console.log('Pressed')}>
            <Text style={{ color: "white", lineHeight: 12, fontSize: 12, paddingHorizontal: 1 }}>WITHDRAW</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  , TabButton:
    { width: "20%", height: 28, display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#0063F5", padding: 0, borderRadius: 8, color: "white", paddingHorizontal: 2 }
});
