...
const styles = StyleSheet.create({
  ...
  , TabButton:
    { width: "20%", height: 28, display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#0063F5", lineHeight: 20, fontSize: 20, padding: 0, borderRadius: 8, color: "white" }
});
